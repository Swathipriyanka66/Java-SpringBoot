...
import com.jobiak.empapi.services.MobileServices;
...
public class Product 
{
	...
	public Class<? extends MobileServices> showAll(){
	...
	{
		return new String("I am Priya");
	}
	
	@GetMapping("/mobile/{modelId}")
	public String searchModel(@PathVariable(value="modelId")String modelId)
	{
		return new String(modelId+"Is available in Blue and Black color can be delivered in 24 hours");
	}
	...
	@GetMapping(value="/modify",consumes=MediaType.APPLICATION_JSON_VALUE,
